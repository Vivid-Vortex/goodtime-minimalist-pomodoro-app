...
export const GetUnsyncedSessions = (): Promise<Session[]>                        => call("GetUnsyncedSessions");
export const PushSelectedSessions = (ids: number[]): Promise<CloudSyncStatus>   => call("PushSelectedSessions", ids);
