                    ...
                    hashMapOf(
                        ...
                        "formData" to
                            hashMapOf(
                                ...
                                "overallHealthStatus" to 1.toInt(),
                                ...
                                "approxWastedMinutes" to 0.toInt(),
                                "activity1" to "",
                                "activity2" to "",
                                "activity3" to "",
                                "activity4" to "",
                                ...
                                "sprint" to 6.toInt(),
                                "avdhanaMode" to 0.toInt(),
                                "work1ToWork4Ikigai" to 0.toInt(),
                                "work3Udemy" to 0.toInt(),
                                "work4TechWebsite" to 0.toInt(),
                                "work2Youtube" to 0.toInt(),
                                "work5OnlineSale" to 0.toInt(),
                                "ltgLongTermGoal" to 0.toInt(),
                                "timeWasted" to 0.toInt(),
                                "spentOnEssentials" to 0.toInt(),
                                "finance" to 0.toInt(),
                                "others" to 0.toInt(),
                                "work1Main" to 0.toInt(),
                                "work1Misc" to 0.toInt(),
                                "projectManagement" to 0.toInt(),
                                "learning" to 0.toInt(),
                                "meditation" to 0.toInt(),
                                "exercise" to 0.toInt(),
